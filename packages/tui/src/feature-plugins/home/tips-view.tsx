...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Matrix Code from reading sensitive files",
  "Use {highlight}matrix run{/highlight} for non-interactive scripting",
  "Use {highlight}matrix --continue{/highlight} to resume the last session",
  "Use {highlight}matrix run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}matrix serve{/highlight} for headless API access to Matrix Code",
  "Use {highlight}matrix run --attach{/highlight} to connect to a running server",
  "Run {highlight}matrix upgrade{/highlight} to update to the latest version",
  "Run {highlight}matrix auth list{/highlight} to see all configured providers",
  "Run {highlight}matrix agent create{/highlight} for guided agent creation",
  "Use {highlight}/matrix{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}matrix github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/matrix fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/mc{/highlight} on PR code lines for targeted code reviews",
  "Type {highlight}matrix session archive{/highlight} to clean up old conversations",
  "Use {highlight}matrix diff{/highlight} to see staged changes locally",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/matrix{/highlight} in a container",
  "Use {highlight}/connect{/highlight} with Matrix Code for curated, tested models",

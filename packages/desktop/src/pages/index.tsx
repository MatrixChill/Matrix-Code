                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <div class="w-full">
                                        <Switch>
                                          <Match when={working()}>
                                            <div class="w-full flex flex-col-reverse items-start self-stretch gap-6 max-h-30 overflow-y-auto no-scrollbar pointer-events-none mask-alpha mask-y-from-66% maREMOVED_API_KEY mask-y-to-transparent">

...
export function MessageProgress(props: { assistantMessages: () => AssistantMessageType[]; done?: boolean }) {
  ...
  return (
    <div class="flex flex-col gap-3">
      ...
      {/*              mask-alpha mask-t-from-80% maREMOVED_API_KEY mask-t-to-transparent" */}
      {/*     > */}
      ...
      <Show when={eligibleItems().length > 0}>
        <div
          class="h-30 overflow-hidden pointer-events-none pb-1 
               mask-alpha mask-t-from-33% maREMOVED_API_KEY mask-t-to-transparent
               mask-b-from-95% maREMOVED_API_KEY mask-b-to-transparent"
        >
          <div
